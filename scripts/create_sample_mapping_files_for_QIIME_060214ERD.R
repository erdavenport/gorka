...
write.table(mapping[,c(1:2)], paste(output.path, "JP1_barcodes_",today,"ERD.txt", sep=""), sep="\t", row.names=FALSE, quote=FALSE)
...
write.table(mapping[,c(1:2)], paste(output.path, "JP2_barcodes_",today,"ERD.txt", sep=""), sep="\t", row.names=FALSE, quote=FALSE)
